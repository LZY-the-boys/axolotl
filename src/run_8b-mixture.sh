...
name=$(date +"%Y%m%d-%H%M")
yml=/home/LeiFeng/lzy/axolotl/examples/llama-3/fft-8b-mixture.yaml
...
accelerate launch --main_process_port $(shuf -i25000-30000 -n1) -m axolotl.cli.train /home/LeiFeng/lzy/axolotl/examples/qwen/qlora-mixture.yml \
